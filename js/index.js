var $logoInfo = $('#login-info'),
    $logo = $('#logo-main'),
    $logoTitle = $('.logo-title', $logoInfo),
    $logoSubTitle = $('.logo-sub-title', $logoInfo),
    $logoImgBox = $('.logo-img', $logoInfo),
    $logoPic = $('.logo-pic', $logoInfo),
    $font = $('.logo-font-size', $logoInfo), // 字体大小
    $weight = $('.logo-font-weight', $logoInfo), // 粗细
    $family = $('.logo-font-family', $logoInfo), // 字体
    $textPicker = $('.text-picker', $logoInfo), // 颜色
...
(function() {
    ...
    $textPicker.minicolors({
        opacity: true
    });
})();


var $logoWidth = $('.logo-width', $logoInfo),
...
// 文本信息
(function(win) {
    var logoTitle = $logoTitle[0], //document.getElementById('logo-title'), // 标题位置
        logoSubTitle = $logoSubTitle[0]; // document.getElementById('logo-sub-title'); // 副标题位置
...
(function(win) {
    ...
    win.renderResultLogo = function(opt) {
        ...
        ctx.fillRect(0, 0, _width, _height);
        // 绘图
        var img = $logoPic[0]; //document.getElementById('logo-pic'); // 图片本身
        var imgBox = $logoImgBox[0], //document.getElementById('logo-img'), // 图片容器确定位置
            imgSite = {
